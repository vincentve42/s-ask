            ...
            <form onSubmit={SendForm}>
                <div>
                    <div className="lg:mt-5 lg:mt-3 lg:mt-10">
                        <h1 className="justify-self-center text-3xl font-bold">Welcome Back</h1>
                    </div>   
                    <div className="justify-self-center">
                        <input type="text" placeholder="Email Address" id="email"  value={values.email} onChange={DataBerubah} className="mt-5 p-2 pl-4 rounded-4xl focus:rounded-4xl border hover:border-blue-500 focus:border-blue-500 lg:w-82"/>
                    </div>
                    <div className="justify-self-center">
                    ...
                    <div className="pt-5 flex justify-self-center">
                        <p>Dont Have an Account?</p><a href="/login"><p className="pl-1 text-blue-500">Sign Up</p></a>
                    </div>
                </div>
            </form>
