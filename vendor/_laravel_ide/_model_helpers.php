...
namespace App\Models {
     ...
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\prompt_chat> $prompt_chat
     * @property-read int|null $prompt_chat_count
     ...
     * @property int $prompt_chat_id
     * @property int $id
     * @property-read \App\Models\prompt_chat $prompt_chat
     * @method static \Illuminate\Database\Eloquent\Builder<chat>|chat whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<chat>|chat wherePromptChatId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<chat>|chat whereResponse($value)
     * @method static \Illuminate\Database\Eloquent\Builder<chat>|chat wherePrompt($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<prompt_chat>|prompt_chat whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<prompt_chat>|prompt_chat whereJudul($value)
     * @method static \Illuminate\Database\Eloquent\Builder<prompt_chat>|prompt_chat whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<prompt_chat>|prompt_chat whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<prompt_chat>|prompt_chat whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<prompt_chat>|prompt_chat newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<prompt_chat>|prompt_chat newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<prompt_chat>|prompt_chat query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class prompt_chat extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
